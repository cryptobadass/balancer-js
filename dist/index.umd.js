(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ethersproject/abi'), require('@ethersproject/constants'), require('@ethersproject/bignumber'), require('@ethersproject/address'), require('@ethersproject/bytes'), require('@ethersproject/abstract-signer'), require('@ethersproject/contracts'), require('@balancer-labs/sor'), require('graphql-request'), require('graphql'), require('lodash'), require('axios'), require('@ethersproject/providers')) :
    typeof define === 'function' && define.amd ? define(['exports', '@ethersproject/abi', '@ethersproject/constants', '@ethersproject/bignumber', '@ethersproject/address', '@ethersproject/bytes', '@ethersproject/abstract-signer', '@ethersproject/contracts', '@balancer-labs/sor', 'graphql-request', 'graphql', 'lodash', 'axios', '@ethersproject/providers'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["balancer-js"] = {}, global.abi, global.constants, global.bignumber, global.address, global.bytes, global.abstractSigner, global.contracts, global.sor, global.graphqlRequest, global.graphql, global.lodash, global.axios, global.providers));
})(this, (function (exports, abi, constants, bignumber, address, bytes, abstractSigner, contracts, sor, graphqlRequest, graphql, lodash, axios, providers) { 'use strict';
    ...
    */
    ...
    const BALANCER_NETWORK_CONFIG = {
        ...
        [exports.Network.RINKEBY]: {
            ...
            subgraphUrl: 'https://api.thegraph.com/subgraphs/name/balancer-labs/balancer-rinkeby-v2',
        },
        [exports.Network.GÖRLI]: {
            ...
            multicall: '0x42ad527de7d4e9d9d011ac45b31d8551f8fe9821',
            subgraphUrl: 'https://api.thegraph.com/subgraphs/name/balancer-labs/balancer-goerli-v2',
        },
        ...
        [exports.Network.FUJI]: {
            chainId: exports.Network.FUJI,
    ...
    */
    ...
    class SwapsService {
        constructor(network, sor, provider) {
        ...
        async queryBatchSwap(batchSwap) {
            ...
            const vaultContract = new contracts.Contract(balancerVault, vaultAbi, this.provider);
  ...
  users(
    ...
    class SubgraphPoolDataService {
        ...
        async getPools() {
            ...
            return getOnChainBalances(mapped, this.network.multicall, this.network.vault, this.provider);
        }
    ...
    class SorFactory {
        static createSor(network, sdkConfig, provider, subgraphClient) {
            const sorConfig = SorFactory.getSorConfig(sdkConfig);
            const poolDataService = SorFactory.getPoolDataService(network, sorConfig, provider, subgraphClient);
            const tokenPriceService = SorFactory.getTokenPriceService(network, sorConfig, subgraphClient);
            return new sor.SOR(provider, network, poolDataService, tokenPriceService);
        }
    ...
    class BalancerSDK {
        constructor(config) {
            ...
            this.sor = SorFactory.createSor(this.network, config, this.provider, this.subgraphClient);
        ...
        getNetworkConfig(config) {
            ...
            if (typeof config.network === 'number') {
                ...
                return {
                    ...networkConfig,
                    subgraphUrl: (_a = config.customSubgraphUrl) !== null && _a !== void 0 ? _a : networkConfig.subgraphUrl,
                };
            }
            return {
                ...config.network,
                subgraphUrl: (_b = config.customSubgraphUrl) !== null && _b !== void 0 ? _b : config.network.subgraphUrl,
            };
        }
    }
